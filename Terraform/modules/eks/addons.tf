...
resource "aws_eks_addon" "kube_proxy" {
  ...
  tags = {
    Name = "${var.default["env"]}-${var.default["project"]}-kube-proxy"
  }
}
...
resource "aws_eks_addon" "vpc_cni" {
  ...
  tags = {
    Name = "${var.default["env"]}-${var.default["project"]}-vpc-cni"
  }
}
...
resource "aws_eks_addon" "coredns" {
  ...
  tags = {
    Name = "${var.default["env"]}-${var.default["project"]}-coredns"
  }
}
...
resource "aws_eks_addon" "metrics_server" {
  ...
  tags = {
    Name = "${var.default["env"]}-${var.default["project"]}-metrics-server"
  }
}
...
resource "aws_iam_role" "ebs_csi" {
  name               = "${var.default["env"]}-${var.default["project"]}-ebs-csi-role"
...
resource "aws_eks_addon" "ebs_csi_driver" {
  ...
  tags = {
    Name = "${var.default["env"]}-${var.default["project"]}-ebs-csi-driver"
  }
}
...
resource "aws_iam_role" "lbc" {
  name               = "${var.default["env"]}-${var.default["project"]}-lbc-role"
  assume_role_policy = data.aws_iam_policy_document.lbc_assume_role.json
}

resource "aws_iam_policy" "lbc" {
  name = "${var.default["env"]}-${var.default["project"]}-lbc-policy"
...
# ─── IRSA: Karpenter (only when enable_karpenter = true) ─────────────────────
...
resource "aws_iam_role" "karpenter" {
  count              = var.enable_karpenter ? 1 : 0
  name               = "${var.default["env"]}-${var.default["project"]}-karpenter-role"
  assume_role_policy = data.aws_iam_policy_document.karpenter_assume_role[0].json
}

resource "aws_iam_policy" "karpenter" {
  count = var.enable_karpenter ? 1 : 0
  name  = "${var.default["env"]}-${var.default["project"]}-karpenter-policy"
...
resource "aws_sqs_queue" "karpenter_interruption" {
  count                     = var.enable_karpenter ? 1 : 0
  name                      = "${var.default["env"]}-${var.default["project"]}-karpenter"
...
resource "aws_cloudwatch_event_rule" "karpenter_interruption" {
  ...
  name        = "${var.default["env"]}-${var.default["project"]}-karpenter-${each.key}"
  description = "Karpenter interruption rule: ${each.key}"
